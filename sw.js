const CACHE='physiquerush-mi-v11-home-athlete-v25';
const APP_SHELL=[
  ...
  './assets/icons/icon-32.png','./assets/icons/icon-64.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/icons/icon-1024.png','./assets/icons/icon-maskable-192.png','./assets/icons/icon-maskable-512.png','./assets/icons/apple-touch-icon-180.png','./assets/brand/physiquerush-symbol-master.png','./assets/characters/home-athlete-v24.png','./assets/characters/home-athlete-v25.png'
];
