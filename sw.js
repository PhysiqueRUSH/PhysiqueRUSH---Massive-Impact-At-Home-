const CACHE='physiquerush-mi-v10-home-athlete-v24-final';
const APP_SHELL=[
  './','./index.html','./css/app.css','./css/impact-theme.css','./css/home-v23.css','./css/home-v24.css','./css/home-footer.css','./manifest.webmanifest',
  ...
  './assets/icons/icon-32.png','./assets/icons/icon-64.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/icons/icon-1024.png','./assets/icons/icon-maskable-192.png','./assets/icons/icon-maskable-512.png','./assets/icons/apple-touch-icon-180.png','./assets/brand/physiquerush-symbol-master.png','./assets/characters/home-athlete-v24.png'
];
